  ...
  actions: {
    async [TRENDING_COINS_SEARCH]({ dispatch, commit }) {
      const result = await dispatch(
        ...
        {
          method: "get",
          url: "/analytics/trending/coins",
          loading: `trending/coins/${TRENDING_COINS_RESULTS_LOADING}`,
        },
        { root: true }
      );

      if (result.data) commit(`trending/coins/${TRENDING_COINS_RESULTS}`, result.data, { root: true });
    },
  },
};
